...
// Default static moments for guests
...
function Moments() {
    ...
    const handleChange = (e) => {
        ...
        const key = map[id];
        setForm(prev => ({ ...prev, [key]: files ? files[0] : value }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.image) {
            ...
            try {
                const res = await axios.post(
                    "https://api.cloudinary.com/v1_1/dy3pvt29a/image/upload",
                    formData
                );
        ...
        try {
            ...
            // Update local state with saved moment
                        ...
                        <div className="moment-box" key={index}>
                            <div className={`moment-image mb-3 position-relative ${!(moment.image || moment.imageUrl) ? "no-image-wrapper" : ""}`}>
                                ...
                                {moment.image || moment.imageUrl ? (
                                    <img
                                        className="img-fluid"
                                        src={moment.image ? moment.image : moment.imageUrl}
                                        alt={moment.title}
                                    />
                                ) : (
                            ...
                            <div className="moment-content pb-3 px-3 pt-0">
                                ...
                                <div className="bottom-container">
                                    <p className="m-0 p-0 text-dark fs-6">
                                        <span><i className="bi bi-calendar me-2"></i></span>{formatDate(moment.date)}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="modal-content">
                            <div className="modal-body">
                                ...
                                <div className="form mt-3">
                                    ...
                                    <form className="row g-2 py-2 mt-3" onSubmit={handleSubmit}>
