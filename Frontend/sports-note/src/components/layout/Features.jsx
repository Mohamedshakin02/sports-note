                ...
                <div className='bottom-container pt-3 pt-lg-5 mb-5'>
                    ...
                    <div className='feature-box d-flex flex-column justify-content-between ps-4 py-3'>
                        ...
                        <div className='box-link'>
                            <p><Link to="/moments" title="Explore Moments" className="text-decoration-none fs-5 m-0 p-0">Explore</Link></p>
                        </div>
                    </div>
                    ...
                    <div className='feature-box d-flex flex-column justify-content-between ps-4 py-3'>
                        ...
                        <div className='box-link'>
                            <p><Link to="/fixtures" title="Explore Fixtures" className="text-decoration-none fs-5 m-0 p-0">Explore</Link></p>
                        </div>
                    </div>
                    ...
                    <div className='feature-box d-flex flex-column justify-content-between ps-4 py-3'>
                        ...
                        <div className='box-link'>
                            <p><Link to="/quotes" title="Explore Quotes" className="text-decoration-none fs-5 m-0 p-0">Explore</Link></p>
                        </div>
                    </div>
                    ...
                    <div className='feature-box d-flex flex-column justify-content-between ps-4 py-3'>
                        ...
                        <div className='box-link '>
                            <p><Link to="/techniques" title="Explore Techniques" className="text-decoration-none fs-5 m-0 p-0">Explore</Link></p>
                        </div>
                    </div>
                    ...
                    <div className='feature-box d-flex flex-column justify-content-between ps-4'>
                        ...
                        <div className='box-link'>
                            <p><Link to="/sessions" title="Explore Sessions" className="text-decoration-none fs-5 m-0 p-0">Explore</Link></p>
                        </div>
                    </div>
