            ...
            <Swiper
              ...
              pagination={{
                ...
                renderBullet: (index, className) => {
                  ...
                  if (image) return `<span class="${className} custom-bullet"><img loading="lazy" src="${image}" alt="${author}" class="bullet-image"/></span>`;
                ...
                <SwiperSlide key={index}>
                  <div className="quote-box d-flex p-3 px-4">
                    <div className="image-container me-2 me-sm-4 d-flex justify-content-center align-items-center">
                      {item.image || item.imageUrl ? <img loading="lazy" src={item.image || item.imageUrl} alt={item.author} className="img-fluid" /> : <i className="bi bi-person-fill display-3"></i>}
                    </div>
